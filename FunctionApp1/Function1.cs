...
namespace FunctionApp1
{
    public static class Function1
    {
        ...
        public static async Task<IActionResult> Run(
            ...
            ILogger logger,
            [Blob("%Function1BlobFilePath%", FileAccess.Write, Connection = "Function1BlobConnectionString")] CloudBlobContainer cloudBlobContainer)
        {
            logger.LogInformation(
                $"{nameof(Function1)} trigger function processed a request.");
